...
class TransactionListAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "company_price", "quantity", "retail_amount", "client_amount", "company_amount", "client_profit", "company_profit", "fee", "debt"
        ]
...
class TransactionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "card", "company", "driver", "store", "state", "date", "item", "unit_number", "retail_price", "client_price", 
            "quantity", "retail_amount", "client_amount",  "client_profit", "transaction_fee", "fee", "debt"
        ]
